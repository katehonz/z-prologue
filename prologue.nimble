...
task tjwt, "Test JWT authentication":
  exec "nim c -r -d:release examples/jwt_auth/app.nim"

task twebsocketchat, "Test WebSocket chat":
  exec "nim c -r -d:release examples/websocket_chat/app.nim"
